...
def preprocess_data(df):
    ...
    non_numeric_columns = df.select_dtypes(include=[object]).columns  # Changed to include only object types
    ...
    # Handle missing values for non-numeric (categorical) columns
